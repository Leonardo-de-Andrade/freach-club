...
public class IfrFornecedor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tfdEmpresa.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/star.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jftfTelefone, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 361, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(tfdEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel5)))
                .addGap(19, 19, 19)
                .addComponent(btnSalvar)
                .addContainerGap())
        ...
        tfdBuscaTelefone.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfdBuscaTelefoneActionPerformed(evt);
            }
        });

        jLabel7.setText("Telefone");

        tfdBuscaEmpresa.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tfdBuscaNome, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel7)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tfdBuscaTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(12, 12, 12)
                                .addComponent(jLabel6)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tfdBuscaEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel7)
                    .addComponent(tfdBuscaEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (tfdNome.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Por favor, digite o nome do fornecedor", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        } else if (jftfTelefone.getText().equals("(  )      -    ")) {
            JOptionPane.showMessageDialog(null, "Por favor, digite o número de telefone do fornecedor", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
            ...
            return;
        } else if (tfdEmpresa.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Por favor, digite a empresa do fornecedor", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }

        Fornecedor fornecedor = new Fornecedor();
        fornecedor.setNome(tfdNome.getText());
        fornecedor.setTelefone(jftfTelefone.getText());
        fornecedor.setEmpresa(tfdEmpresa.getText());
        if (tfdId.getText().equals("")) {
            fornecedor.setId(id);
        } else {
            fornecedor.setId(Integer.parseInt(tfdId.getText()));
        }

        FornecedorDAO fornecDAO = new FornecedorDAO();

        try {
            if (tfdId.getText().equals("") && fornecDAO.salvar(fornecedor)) {
                JOptionPane.showMessageDialog(null, "Registro salvo com sucesso!");
            } else if (!tfdId.getText().equals("") && fornecDAO.atualizar(fornecedor)) {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        new FornecedorDAO().popularTabela(tblFornecedor, tfdBuscaNome.getText(), tfdBuscaTelefone.getText(), tfdBuscaEmpresa.getText());
    }//GEN-LAST:event_btnPesquisarActionPerformed

    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed

        if (tblFornecedor.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Selecione o fornecedor que deseja editar!", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        Fornecedor fornec = fornecDAO.consultarId(id);

        if (fornec != null) {
            tfdNome.setText(fornec.getNome());
            jftfTelefone.setText(fornec.getTelefone());
            tfdEmpresa.setText(fornec.getEmpresa());
            tfdId.setText(String.valueOf(fornec.getId()));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (tblFornecedor.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Selecione o fornecedor que deseja excluir!", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        } else if (tblFornecedor.getValueAt(tblFornecedor.getSelectedRow(), 0).equals(id)) {
            JOptionPane.showMessageDialog(null, "Não é possível excluir um fornecedor que está sendo editado!", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void tfdBuscaTelefoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfdBuscaTelefoneActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfdBuscaTelefoneActionPerformed
