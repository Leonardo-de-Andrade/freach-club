 ...
 * @author Leonardo
 */
public class DlgPesquisarCategoriaProduto extends javax.swing.JDialog {

    IfrProduto ifrProdutolocal = null;

    public DlgPesquisarCategoriaProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        new CategoriaProdutoDAO().popularTabela(tblCategoriaProduto, tfdBuscaNome.getText(), tfdBuscaDescricao.getText());
    }

    public DlgPesquisarCategoriaProduto(java.awt.Frame parent, boolean modal, IfrProduto IfrProduto) {
        super(parent, modal);
        initComponents();
        new CategoriaProdutoDAO().popularTabela(tblCategoriaProduto, tfdBuscaNome.getText(), tfdBuscaDescricao.getText());
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tfdBuscaNome, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(23, 23, 23)
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(tfdBuscaDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        String id = String.valueOf(tblCategoriaProduto.getValueAt(tblCategoriaProduto.getSelectedRow(), 0));
        String nome = String.valueOf(tblCategoriaProduto.getValueAt(tblCategoriaProduto.getSelectedRow(), 1));

        ifrProdutolocal.definirCategoriaProduto(id, nome);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPesquisarCategoriaProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgPesquisarCategoriaProduto dialog = new DlgPesquisarCategoriaProduto(new javax.swing.JFrame(), true);
